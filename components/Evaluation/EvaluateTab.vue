<template>
    ...
    <div id="EvaluatePage">
            ...
            <div>
                <div id="PlotTableArea" class="p-2" v-if="plotTableData.length > 0">
                    <div v-if="plotTableList && plotTableList.length > 1">
                        <label for="PlotTableOptions" class="pr-2 pt-3">Select Simulation Time Period Data Table
                        </label>
                    ...
                    <div class="pt-6 pb-2">
                        <DataTable :value="plotTableData" scrollable scroll-height="500px" fixedHeader=true
                            :multi-sort="true">
                            <Column v-for="col of plotTableColumns" :key="col.value" :field="col.value"
                                :header="col.header" sortable></Column>
                        </DataTable>
                    </div>
                </div>
            </div>
        ...
        <div id="SupplementalTableArea" class="p-2" v-if="selectedSupplementalTable">
            <DataTable :value="iterationMetricsData" scrollable scroll-height="500px" fixedHeader=true
                :multi-sort="true" v-if="iterationMetricsData && selectedSupplementalTable == 1">
...
onMounted(async () => {
    ...
    console.log("EvaluateTab for Evaluation mounted")
});

const setupIterationData = () => {
    ...
    if (iterations.value && iterations.value_data) {
...
const setupPerformancData = async () => {
