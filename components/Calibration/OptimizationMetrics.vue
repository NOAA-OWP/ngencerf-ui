            ...
            <div class="flex-row">
               <div class="flex row-span-1">
                  <div id="OptAlg" class="bordered">
                     ...
                     Name:&nbsp;&nbsp;
                     <Select clas="rounded-md" v-model="uiOptimization" :options="getOptimizationAlgorithmOptionsList"
                        optionLabel="name" optionValue="name" placeholder=""
               ...
               <div class="flex-row mt-2">
                  ...
                  <div id="ClearTableBtn" class="mb-5 ngenButtonDiv"><button @click="resetOptimizationInputs">Clear <i
               ...
               <div class="flex-row">
                  <div id="CalStop" class="bordered">
                     ...
                     <InputNumber inputId="stop-criteria" v-model="uiStopCriteria" showButtons :min="0"></InputNumber>
                     <span class="ml-2">Interations</span>
                  </div>
               </div>
            </div>
         </div>
         <div class="grid col-span-1" style="border-left: 1px solid black">
            ...
            <div class="flex-row">
               <div id="ObjFunct" class="bordered">
                  ...
                  Name:&nbsp;&nbsp;
                  <Select class="rounded-md" v-model="uiObjectiveFunction" :options="getObjectiveFunctionOptionsList"
                     optionLabel="name" optionValue="name" placeholder=""
            ...
            <div class="flex-row">
               <div id="Metrics" class="bordered">
                  <div>Metrics</div>
                  <Checkbox inputId="CalcCatMetCB" class="h-5 w-5 mr-3 inline" :binary="true" v-model="cbIsCategorical"
                  ...
                  <br /><br />
                  <Checkbox inputId="CalEventMetCB" class="h-5 w-5 mr-3 inline" :binary="true" v-model="cbIsEvenBased"
            ...
            <div class="flex-row">
               <div id="PlotGenFreq" class="bordered">
                  ...
                  Once Every:&nbsp;&nbsp;<InputNumber inputId="plotFrequency" v-model="uiPlotFrequency" showButtons
                     :min="0">
                  </InputNumber> &nbsp;&nbsp;Interations
               </div>
            </div>
