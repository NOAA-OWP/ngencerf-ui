                  ...
                  <div class="grid grid-cols-6 gap-4">
                     ...
                     <div class="col-span-1">
                        ...
                        <Select v-model="selectedGageValue" filter :options="getGageOptionsList" optionLabel="name"
                           ...
                           class="w-40" @change="onGageSelectionChange"></Select>
                     </div>
                     <div class="col-span-1">
                        Forcing:<br />
                        ...
                        <div v-if="selectedForcingValue.toLowerCase() == 'upload'">
                           <Button label="Upload File" icon="pi pi-upload" @click="showForcingFileUploadDialog( 'Forcing Files' )"></Button>
                     ...
                     <div class="col-span-1">
                        ...
                        <div v-if="selectedObservationalValue.toLowerCase() == 'upload'">
                           <Button label="Upload File" icon="pi pi-upload" @click="showObservationalFileUploadDialog( 'Observational File' )"></Button>                       
                        </div>
                     </div>
                     <div class="col-span-1">&nbsp;</div>
                  </div>
